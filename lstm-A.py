...
# Training Data
x_train = np.load("./saved_data/A/mod/train/branch_arrays.npy")
mask_train = np.load("./saved_data/A/mod/train/mask.npy")
y_train = np.load("./saved_data/A/mod/train/padlabel.npy")
rmdoublemask_train = np.load("./saved_data/A/mod/train/rmdoublemask.npy")

# Dev Data
x_dev = np.load("./saved_data/A/mod/dev/branch_arrays.npy")
mask_dev = np.load("./saved_data/A/mod/dev/mask.npy")
y_dev = np.load("./saved_data/A/mod/dev/padlabel.npy")
rmdoublemask_dev = np.load("./saved_data/A/mod/dev/rmdoublemask.npy")

# Result file
date_folder = datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
results_folder = "D:/Zwischenablage/results/A"
saved_models_folder = "D:/Zwischenablage/saved-models/A"
